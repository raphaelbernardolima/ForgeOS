...
export const ProceduralPreview: React.FC<ProceduralPreviewProps> = ({
  ...
  return (
    <div className={`relative flex flex-col bg-[#0b0e14] rounded-2xl border border-neutral-800 overflow-hidden shadow-2xl ${className}`}>
      ...
      <div className="flex items-center justify-between px-4 py-3 border-b border-neutral-800/80 bg-[#12161f]/90 backdrop-blur text-xs">
        <div className="flex items-center gap-3">
          <span className="font-mono text-neutral-400 font-medium">CAD PREVIEW 2D</span>
          <span className="text-neutral-600">|</span>
          <span className="text-amber-500/90 font-mono uppercase tracking-wider font-semibold">
            {tipo.toUpperCase()}
          </span>
        ...
        {showTechnicalControls && (
          <div className="flex items-center gap-1.5">
            ...
            <button
              ...
              className={`px-2 py-1 rounded transition-colors text-[11px] font-mono flex items-center gap-1 ${
            ...
            {/* Controles de Zoom */}
            <div className="flex items-center bg-neutral-900 border border-neutral-800 rounded px-1 ml-2">
              <button
              ...
              <span className="text-[10px] font-mono text-neutral-400 px-1 tabular-nums w-9 text-center">
                {Math.round(zoom * 100)}%
              </span>
              <button
              ...
              <button
                ...
                className="p-1 text-neutral-400 hover:text-white transition-colors border-l border-neutral-800 ml-0.5"
              >
            ...
            <button
              ...
              className="p-1.5 rounded text-neutral-400 hover:text-white hover:bg-neutral-800 transition-colors ml-1"
            >
